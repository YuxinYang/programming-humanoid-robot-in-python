...
class ClientAgent(object):
    ...
    def set_angle(self, joint_name, angle):
        ...
        '''
        # YOUR CODE HERE
        return self.server.set_angle(self,joint_name, angle)

    def get_posture(self):
        '''return current posture of robot'''
        # YOUR CODE HERE
        return self.server.get_posture(self)
    ...
    def execute_keyframes(self, keyframes):
        ...
        '''
        # YOUR CODE HERE
        return self.server.execute_keyframes(self, keyframes)

    def get_transform(self, name):
        '''get transform with given name
        '''
        # YOUR CODE HERE
        return self.server.get_transform(self, name)

    def set_transform(self, effector_name, transform):
        '''solve the inverse kinematics and control joints use the results
        '''
        # YOUR CODE HERE
        return self.server.set_trasform(self, effector_name, transform)
